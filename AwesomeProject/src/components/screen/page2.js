                ...
                >
                    <View style={{ flexDirection: "row", width: '100%', justifyContent: "space-between" }}>
                        <View style={{ width: 200 }}>
                            ...
                            <Text style={{ width: 189, height: 15, fontSize: 10, fontWeight: '700', color: '#fff', opacity: 0.8, textTransform: "uppercase" }}>{route.username}, crust, toppings</Text>
                        </View>
                        <View style={{ width: 80 }}>
            ...
            <View style={{ alignItems: "center", marginTop: 150 }}>
                <View style={{ width: 330, height: 139, backgroundColor: '#fff', borderRadius: 15, alignItems: "center" }}>
                    <View style={{ flexDirection: "row", marginTop: 20 }}>
                        ...
                        <Text style={{ fontSize: 20, fontWeight: '600', color: "#6D6E9C" }}>crust</Text>
                    </View>
                        ...
                        <View style={style.sizeBtnBox}>
                            ...
                            <View style={style.sizeBtn}>
                                {thinStyleBox ? <LinearGradient colors={['#FFA360', '#F5313F']}
                                    ...
                                    <Text onPress={() => { setThinStyleBox(true), setThikStyleBox(null), setThiknessPrice("$12.00") }} style={style.sizeBtn}>Thin</Text>
                            ...
                            <View style={style.sizeBtn}>
                                {thikStyleBox ? <LinearGradient colors={['#FFA360', '#F5313F']}
                                    ...
                                    <Text onPress={() => { setThikStyleBox(true), setThinStyleBox(null), setThiknessPrice("$14.00") }} style={style.sizeBtn}>Thick</Text>
